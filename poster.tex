...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Freins
        \item Commandite Usinatech
        \item Matériaux fournis?
        \item Scan 3D (autres pièces à scanner?)
        \item Pièces proto?
        \item 
...
\hspace{1cm}
\begin{center}
    \includegraphics[width=\linewidth]{img/GEN_Tresorerie_Cashflow_tableau_Sem10.pdf}
\end{center}
}
