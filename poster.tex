...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Morale des troupes
        \item Gestion petites tâches
        \item Budget moule
        \item Craintes/chokepoint pour les prochaines semaines
...
\hspace{1cm}
\begin{center}
    \includegraphics[width=\linewidth]{img/GEN_Tresorerie_Cashflow_tableau_Sem11.pdf}
\end{center}
}
