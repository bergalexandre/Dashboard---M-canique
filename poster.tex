...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Retour fonctionnement des rencontres techniques
    \end{enumerate}
\end{itemize}
...
\headerbox{Cashflow}{name=cashflow,column=0,span=3,below=risques}{
\vspace{.6cm} % spacing vertical
\hspace{1cm}
\begin{center}
    \includegraphics[scale=.20]{img/cashflow.png}
\end{center}
}
\headerbox{Citation de la semaine}{name=citation,column=0,row=0, span=3,below=cashflow}{
 \textit{"Un joueur qui rend une équipe bonne est plus précieux qu'un bon joueur."}
