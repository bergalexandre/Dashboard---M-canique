...
\begin{flushleft}
    \bf
QUOTE de la semaine : Never give up until you've given out all your very best. It’s better to fail trying, than wondering what could have happened if you tried.
\end{flushleft}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Star CCM+ fonctionne
        \item Site web en cours
        \item Budget
    \end{enumerate}
    \item \textbf{Rencontre technique :}
    \begin{enumerate}
        \item Paramètres de suspension
        \item 
    \end{enumerate}
\end{itemize}
...
\headerbox{Objectifs semaine prochaine}{name=objectifs_prochain,column=2,span=1,below=risques}{
{
    ...
    \item \textbf{Coque :}
    \begin{enumerate}
        \item Compléter un deuxième concept de coque pour comparer, à l'aide de la cfd, avec celui de cette semaine
    ...
    \begin{enumerate}
        \item Créer l'assemblage final Solidworks pour le design review		
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Commencer la rédaction du RCP1	
    \end{enumerate}
    \item \textbf{Freins :}
    \end{itemize}
