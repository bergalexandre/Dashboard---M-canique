...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Premier truc à parler gestion
        \item Deuxième truc à parler gestion
        \item Troisième truc à parler gestion
...
\headerbox{Objectifs deux semaines}{name=objectifs,column=0, row=0, span=3}{{\input{tableaux/taches_accomplies}}}
