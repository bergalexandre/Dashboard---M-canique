...
https://www.overleaf.com/project/60eca6af9007bd1dcc5c2f00
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Signature titulaire - Shell éco-marathon
        \item Avancement Fabrication Coque, châssis et pare-brise
...
{
    \textit{Il va toujours y avoir des obstacles dans votre chemin, rester positif"} -- Michael phelps
%\hspace{1cm}
%\begin{center}
