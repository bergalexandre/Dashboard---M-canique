...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Question sur Choix des MCU
        \item Question sur Spécialisation des MCU
    \end{enumerate}
\end{itemize}
...
\headerbox{Objectifs semaine prochaine}{name=objectifs_prochain,column=2,span=1,below=risques}{
{
    ...
    \begin{enumerate}
        ...
        \item Implémenter la simulation LTSpice de l'inverter dans notre simulateur	
    \end{enumerate}
    \item \textbf{Contrôle :}
    \begin{enumerate}
    ...
    \begin{enumerate}
        \item Support des gens pour tableau de bord
