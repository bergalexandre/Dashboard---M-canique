...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Retour rencontre BRP
        \item Meeting moule SAMCO
        \item Retour rencontre BeSpline
...
\hspace{1cm}
\begin{center}
    \includegraphics[width=\linewidth]{img/GEN_Tresorerie_Cashflow_tableau_Sem8.pdf}
\end{center}
}
