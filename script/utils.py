...
class Speciality():
    ...
    MECA = {'systemes': [Systeme.SIMULATEUR, Systeme.COQUE, Systeme.CHASSIS, Systeme.DIRECTION, Systeme.FREIN, Systeme.THERMIQUE, Systeme.SUSPENSION, Systeme.ERGONOMIE, Systeme.GESTION, Systeme.BATTERIE],
