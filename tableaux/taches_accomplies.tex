...
\begin{tabularx}{\linewidth}{
    ...
    \textbf{Objectif} & \textbf{Responsable}  & \textbf{\% attendu} & \textbf{\% fait} \\\hline
       Intégration des ailes et roues dans les coques (détaillé) & Joé, Charles, J-S & 0\% & 10\%\\\hline
       Terminer simulations sur derrière du véhicule + validations sur la fabricabilité & Joé, Chalres, J-S & 50\% & 50\%\\\hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{
    ...
    \hline
    \textbf{Objectif} & \textbf{Responsable}  & \textbf{\% attendu} & \textbf{\% fait} \\\hline
       Bracket d'intégration au châssis.&Alex & 0\%& 0\% \\\hline
       Fichier poids.&Alex & 0\%& 0\% \\\hline
       DCL et calculs analytiques des pièces de suspension (Matlab).&Alex & 75\%& 75\% \\\hline
       Choix des roulements avec SKF &Alex  & 50\%& 100\% \\\hline  
       FEA de la suspension &Alex, Jérémi & 25\% & 25\% \\\hline  
       Optimisation/FEA des roues. & Jérémi & 10\% & 10\% \\\hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{
    ...
    \hline
    \textbf{Objectif} & \textbf{Responsable}  & \textbf{\% attendu} & \textbf{\% fait} \\\hline
        Faire fiter le système direction avec les autres systèmes et s'assurer d'avoir un bon ackermann.&Gabriel  & 80\% & 70\%
        \\\hline 
        DCL et calculs analytiques des pièces de la direction &Gabriel  & 40\% & 40\%
        \\\hline
        Début des FEA direction  &Gabriel  & 20\% & 10\%
        \\\hline
\end{tabularx}
