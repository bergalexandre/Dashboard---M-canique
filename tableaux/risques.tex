\begin{tabularx}{\linewidth}{
    ...
    \textbf{Risque} & \textbf{Mitigation} & \textbf{Conséquence} & \textbf{Priorité}\\\hline
     ...
     Vision non adéquate du pare-brise et des fenêtres & Nous avons des panneaux pour mégaGéniale de prêt et minimalement fonctionnel & Si le pilote ne voit pas bien, cela peut causer des enjeux à la compétition & 3/5
  \end{tabularx}
         \\\hline  
